<template>
  <div class="box">
    ...
    <img src="@/assets/imgs/light_L.svg" :style="{width:lightWidth}" class="showZsk" v-if="lightS"  @contextmenu.prevent="hide" @click="showZsk(0,false)">
    <img src="@/assets/imgs/light_H.svg" :style="{width:lightWidth}" class="showZsk" v-if="!lightS" @contextmenu.prevent="hide" @click="showZsk('60%',true)">
    ...
    export default {
      ...
      methods:{
        ...
        showZsk(s,t){
          this.kuStyle = s;
          this.lightS = t;
          this.lightWidth = "50px";
        },
        hide(){
          this.lightWidth = "20px";
        },
      },
      mounted(){

  ...
  <div class="content">
    <div class="common">
      ...
      <span class="label">
        ...
        <el-button type="primary" plain style="margin-left: 20px;" @click="find">查询</el-button>
        <el-button type="danger" plain style="margin-left: 20px;" @click="clearFind">重置</el-button>
      </div>
      <div style="height: 88%;">

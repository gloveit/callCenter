...
export default {
  ...
  methods:{
   ...
   subArticle () {
     ...
     let articleKindId = that.articleKindId;
       ...
       if(valid){
         this.axios({
           ...
           if(status === 'success'){
            ...
            //  that.content = '';
             this.$message({message:"修改文章成功",type:'success'})
           }else{
             this.$message({message:"修改文章失败",type:'success'})
           }
         })
       }else{
  ...
  watch: {
    '$store':{
      handler(newvalue,oldvalue){
        ...
        this.ruleForm.articleKind = newvalue.state.articleStatus.kindid;
        this.ruleForm.delivery = newvalue.state.articleStatus.istop
      },
      immediate:true,
    }
  },

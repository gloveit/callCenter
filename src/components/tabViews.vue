...
<script>
    export default {
        ...
        methods:{
          goRoute(title,path){
            console.log("缓存的路由:",this.$store.state.keepComs)
            if(path == "/weChat"){
